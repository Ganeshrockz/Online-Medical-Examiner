...
session_start();
$_SESSION["currentpatient"]=" ";
if(isset($_POST['submit']))
{
    $username=$_POST['username'];
    $pass=$_POST['password'];
    $que1="SELECT * FROM patient where username like '$username' and password like '$pass'";
    ...
    else if(mysqli_num_rows($rec)>0)
    {
        ...
        $_SESSION["currentpatient"]=$username;
...
<form class="well well-lg" action="#" method="POST">
	<center><label><strong>Patient Login</strong></label></center>
